...
\newfontfamily\thaifont[Path=fonts/,Extension=.ttf,
  UprightFont=THSarabunNew,BoldFont=THSarabunNew-Bold,Scale=1.1]{THSarabunNew}
...
\begin{frame}{9.1 SHAP Global Importance}
  \footnotesize
  \begin{center}
    \includegraphics[width=0.5\textwidth]{figures/shap_summary.png}
  \end{center}
  \begin{itemize}
