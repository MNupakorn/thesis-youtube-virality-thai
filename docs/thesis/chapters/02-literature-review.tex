...
\textcite{dietterich1998approximate} แนะนำการทดสอบนี้สำหรับการเปรียบเทียบ
2 ตัวจำแนก
...
\label{eq:attnroll}
\end{equation}
ผลลัพธ์คือ ``ความสนใจรวม'' ของแต่ละ token ที่มีต่อการพยากรณ์สุดท้าย \textcite{chefer2021transformer} ขยายแนวคิดนี้ด้วย gradient-weighted
