...
(5) การจัดการความไม่สมดุลของชั้น (6) การปรับเทียบความน่าจะเป็น และ
...
แนวคิดเรื่อง ``ความไวรัล'' ของเนื้อหาออนไลน์เริ่มต้นจาก Gladwell
\cite{gladwell2000tipping} ซึ่งใช้คำนี้ในบริบทของจุดเปลี่ยน (tipping point)
ของการแพร่กระจายทางสังคม Berger \& Milkman \cite{berger2012makes} วิเคราะห์
...
การแพร่กระจาย ในงานพยากรณ์ Cheng et~al.\ \cite{cheng2014can} ระบุว่าการพยากรณ์
...
(ก) \emph{เกณฑ์เชิงสัมบูรณ์} เช่น Trzcinski \& Rokita \cite{trzcinski2017popularity}
ตัดที่ 1 ล้านยอดเข้าชม และ (ข) \emph{เกณฑ์เชิงสัมพัทธ์} เช่น Khosla et~al.\
\cite{khosla2014popularity} ใช้ z-score ภายในผู้สร้างเนื้อหา การศึกษานี้เลือก
แนวทาง (ข) เพราะเกณฑ์สัมบูรณ์ทำให้ช่องขนาดใหญ่กลายเป็นชั้นบวกทั้งหมด ซึ่งทำลาย
ความแยกแยะของแบบจำลอง

\subsection{งานพยากรณ์ความนิยมบน YouTube และแพลตฟอร์มอื่น}

\textbf{Pinto et~al.\ \cite{pinto2013using}} เสนอแบบจำลอง Multivariate Linear
...
\textbf{Hoiles et~al.\ \cite{hoiles2017engagement}} ศึกษาว่าฟีเจอร์ใดบนวิดีโอ
...
\textbf{Trzcinski \& Rokita \cite{trzcinski2017popularity}} ใช้คุณลักษณะภาพและ
...
\textbf{Lee et~al.\ \cite{lee2010approach}} ใช้ Naïve Bayes บนคำสำคัญของชื่อ
วิดีโอ YouTube พบว่าคำที่กระตุ้นอารมณ์มีน้ำหนักสูงในการพยากรณ์ความนิยม

\textbf{Cheng et~al.\ \cite{cheng2014can}} วิเคราะห์การ ``cascade'' ของรูปภาพ
...
สถิติที่เข้มงวด งานวิจัยปัจจุบันจึงเข้าไปอุดช่องว่างเชิงระเบียบวิธี
...
\subsection{ฟีเจอร์เชิงข้อความ}

ชื่อวิดีโอเป็นจุดสัมผัสแรก (first impression) ของผู้ชม
Potthast et~al.\ \cite{potthast2018clickbait} เสนอเครื่องมือ
...
สำหรับภาษาไทย Phatthiyaphaibun et~al.\ \cite{phatthiyaphaibun2016thainlp}
จัดทำ PyThaiNLP toolkit ที่รวมการตัดคำด้วย \texttt{newmm} ซึ่งเป็นพื้นฐาน
ของการสกัดฟีเจอร์ลำดับคำในงานนี้

\subsection{ฟีเจอร์เชิงอารมณ์}

Suriyawongkul et~al.\ \cite{suriyawongkul2019wisesight} เสนอชุดข้อมูล
...
ขนาดของช่องและความถี่ในการอัปโหลดเป็นตัวแปรที่ Hoiles et~al.\
\cite{hoiles2017engagement} และ Borghol et~al.\ \cite{borghol2012untold}
ยืนยันว่ามีผลสำคัญ Borghol et~al.\ ค้นพบว่าหลักการ ``the rich get richer''
ทำงานบน YouTube ในแง่ที่ว่าวิดีโอที่มีช่องขนาดใหญ่และมีฐานผู้ติดตามได้รับ
yt-discovery bonus ส่งผลให้มีโอกาสไวรัลสูงกว่าเชิงสถิติ

ฟีเจอร์เชิงเวลา (เช่น เวลาที่เผยแพร่ในรอบสัปดาห์ ฤดูกาล วันเทศกาล) ก็มีผลตาม
Wu et~al.\ \cite{wu2016unfolding} ที่วิเคราะห์การมีส่วนร่วมตามเวลาเผยแพร่บน
Twitter
...
\textbf{Vaswani et~al.\ \cite{vaswani2017attention}} เสนอแบบจำลอง Transformer
...
ของแต่ละ token ในลำดับ ความสามารถจัดการความสัมพันธ์ระยะไกลใน $O(n^2)$ ของ
Self-Attention เป็นจุดแข็งหลัก แม้จะตามมาด้วยข้อจำกัดเรื่องความซับซ้อนเมื่อ
ลำดับยาวมาก

\subsection{BERT และ RoBERTa}

\textbf{Devlin et~al.\ \cite{devlin2019bert}} เสนอ BERT (Bidirectional
...
\textbf{Liu et~al.\ \cite{liu2019roberta}} พัฒนา RoBERTa (Robustly Optimised
...
\textbf{Howard \& Ruder \cite{howard2018ulmfit}} แสดงให้เห็นว่าการปรับจูนแบบ
...
LoRA \cite{hu2022lora} และ QLoRA \cite{dettmers2023qlora} ซึ่งฝึกเฉพาะ
adapter ขนาดเล็ก ลดความต้องการ VRAM ลงได้มาก เหมาะกับแบบจำลองขนาดใหญ่ในระดับ
หลาย B พารามิเตอร์ รหัสฐานของงานนี้รองรับ QLoRA สำหรับ decoder LLM ผ่าน
...
\textbf{Logistic Regression} เป็นเส้นฐานสากลสำหรับการจำแนกประเภททวิภาค
\textbf{XGBoost} \cite{chen2016xgboost} และ \textbf{LightGBM}
\cite{ke2017lightgbm} เป็น Gradient Boosting Decision Tree ที่ปรับให้รวดเร็ว
และจัดการกับข้อมูลขนาดใหญ่ได้ดี LightGBM ใช้ leaf-wise tree growth และ
histogram-based split finding ซึ่งเร็วกว่า XGBoost ในกรณีส่วนใหญ่ ในงาน
benchmark Kaggle, LightGBM และ XGBoost มักจะอยู่ใน top-3 ของแบบจำลองที่ใช้
บนข้อมูล tabular

\subsection{TF-IDF กับการจำแนกข้อความ}

\textbf{Sparck Jones \cite{sparckjones1972tfidf}} เสนอ Inverse Document
...
ความนิยมในงาน Kaggle เช่น KDD Cup 2014 และในอุตสาหกรรม Cheng et~al.\
\cite{cheng2016widedeep} เสนอ Wide \& Deep โดย Google ที่รวม linear features
...
ในปี ค.ศ.\ 1992 ซึ่งใช้ \emph{meta-learner} เรียนรู้วิธีรวมผลพยากรณ์ของแบบ
จำลองฐานหลายตัว Breiman \cite{breiman1996stacked} ขยายและพิสูจน์ว่า stacking
ได้ลด generalisation error ลงตามทฤษฎี การประยุกต์ใช้ stacking ที่ประสบความ
สำเร็จมีมากในการประกวด Kaggle เช่น Netflix Prize Bell \& Koren
\cite{bell2007lessons} รายงานว่าการประกอบหลายแบบจำลองช่วยเพิ่มประสิทธิภาพ
อย่างมีนัยสำคัญ ในงานปัจจุบันเราใช้ Logistic Regression เป็น meta-learner
เพราะตีความได้ง่ายและไม่ overfit ง่ายเมื่อแบบจำลองฐานเป็นความน่าจะเป็นที่
ปรับเทียบมาแล้ว

\section{การจัดการความไม่สมดุลของชั้น}
\label{sec:lit-imbalance}

ในปัญหาปัจจุบันอัตราชั้นบวกอยู่ที่ 10.16\% ซึ่งถือว่ามีความไม่สมดุลปานกลาง
(moderate imbalance) วิธีแก้ไขที่ใช้กันทั่วไปแบ่งเป็น 3 กลุ่ม

\subsection{การปรับสมดุลของข้อมูล (Resampling)}

\textbf{Undersampling} ลดจำนวนตัวอย่างชั้นมาก (negative) ลงให้สมดุลกับชั้นน้อย
(positive) จุดอ่อนคือสูญเสียข้อมูลส่วนหนึ่ง \textbf{Oversampling} เช่น SMOTE
\cite{chawla2002smote} สร้างตัวอย่างชั้นน้อยเพิ่มเติมโดยสังเคราะห์ระหว่าง
เพื่อนบ้าน $k$-NN จุดอ่อนคือใน feature space ที่มีมิติสูงและกระจัดกระจาย
SMOTE อาจสร้างข้อมูลที่ไม่สมจริง He \& Garcia \cite{he2009learning} สรุปว่า
สำหรับ NLP บนข้อความสั้น undersampling มักเป็นทางเลือกที่ปลอดภัยกว่า

\subsection{การถ่วงน้ำหนัก (Class Weighting) และ Focal Loss}

วิธีถ่วงน้ำหนักให้กับชั้นน้อยใน cross-entropy loss เป็นวิธีที่ตรงไปตรงมา
\textbf{Focal Loss} \cite{lin2017focal} ถูกเสนอเพื่อให้แบบจำลองเน้นตัวอย่างที่
จำแนกได้ยาก โดยใส่แฟกเตอร์ $(1-p_t)^\gamma$ เข้าไปลดน้ำหนักของตัวอย่างที่
จำแนกได้ง่าย ในงานวิจัยปัจจุบันการทดลองเบื้องต้นบน WangchanBERTa พบว่า Focal
Loss ($\gamma=2$) ไม่ได้ให้ผลดีกว่า cross-entropy แบบธรรมดาที่รวมกับ
undersampling

\subsection{การปรับเปลี่ยน Decision Threshold}

นอกจากปรับ training-side ยังสามารถปรับ inference-side ด้วยการเลื่อน
threshold การจำแนกออกจาก 0.5 ไปยังจุดที่ optimal สำหรับ F1 ของชั้นบวก
(He et~al.\ \cite{he2008imbalanced}) ในงานวิจัยปัจจุบันเราใช้แนวทางนี้:
threshold ถูกเลือกจาก validation fold ด้วย scan ละเอียด แล้วใช้เป็น final
inference threshold
...
\textbf{Zadrozny \& Elkan \cite{zadrozny2002isotonic}} เสนอ isotonic regression
...
Niculescu-Mizil \& Caruana \cite{niculescu2005predicting} เปรียบเทียบ
...
\label{eq:mcnemar}
\end{equation}
ภายใต้ $H_0$: แบบจำลอง 2 ตัวมีอัตราความผิดพลาดเท่ากัน สถิติเข้าใกล้ $\chi^2_1$
Dietterich \cite{dietterich1998approximate} แนะนำการทดสอบนี้สำหรับการเปรียบเทียบ
2 ตัวจำแนก
...
Efron \cite{efron1979bootstrap} เสนอ Bootstrap resampling สำหรับประมาณการ
...
\textbf{Lundberg \& Lee \cite{lundberg2017shap}} เสนอ SHAP (SHapley Additive
...
\textbf{Ribeiro et~al.\ \cite{ribeiro2016should}} เสนอ LIME (Local
...
\textbf{Abnar \& Zuidema \cite{abnar2020quantifying}} เสนอ ``attention
...
\label{eq:attnroll}
\end{equation}
ผลลัพธ์คือ ``ความสนใจรวม'' ของแต่ละ token ที่มีต่อการพยากรณ์สุดท้าย Chefer
et~al.\ \cite{chefer2021transformer} ขยายแนวคิดนี้ด้วย gradient-weighted
relevance propagation งานวิจัยปัจจุบันใช้ rollout แบบ Abnar \& Zuidema เพราะ
เป็น baseline ที่ใช้แพร่หลายและไม่ต้อง backprop

\section{สรุปบทและการวางตำแหน่งของงานวิจัย}
