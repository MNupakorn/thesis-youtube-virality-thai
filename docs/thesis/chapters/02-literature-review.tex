...
รวมผลพยากรณ์ของแบบจำลองฐาน (base models) หลายตัว Breiman \cite{breiman1996stacked}
...
Bell \& Koren \cite{bell2007lessons} รายงานว่าการรวมแบบจำลองหลายตัวช่วยเพิ่ม
...
ข้อจำกัดของวิธีนี้คือสูญเสียข้อมูลส่วนหนึ่ง \textbf{Oversampling} เช่น SMOTE
\cite{chawla2002smote} สร้างตัวอย่างของชั้นที่มีข้อมูลน้อยเพิ่มโดยสังเคราะห์
ระหว่างเพื่อนบ้าน $k$-NN ข้อจำกัดคือใน feature space ที่มีมิติสูงและกระจัด
กระจาย SMOTE อาจสร้างข้อมูลที่ไม่สมจริง He \& Garcia \cite{he2009learning}
...
threshold ถูกเลือกจาก validation fold ด้วยการสแกนอย่างละเอียด แล้วใช้เป็น
