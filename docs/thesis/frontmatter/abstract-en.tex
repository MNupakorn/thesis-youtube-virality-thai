...
\textbf{Title}         & \thesistitleEN \\[4pt]
\textbf{Students}      & \authoroneEN\ \ Student ID\ \studentidone \\
                        & \authortwoEN\ \ Student ID\ \studentidtwo \\
                        & \authorthreeEN\ \ Student ID\ \studentidthree \\[4pt]
\textbf{Degree}        & Bachelor of Science (Applied Statistics and Data Analytics) \\
\textbf{Department}    & Statistics \\
\textbf{School}        & Science \\
\textbf{University}    & \universityEN\ (KMITL) \\
